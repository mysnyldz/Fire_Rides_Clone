...
namespace Managers.Pool
{
    public class ObjectPoolCreator : MonoBehaviour
    {
        ...
        {
            foreach (var VARIABLE in _poolData.data)
            {
        ...
        private GameObject FabricateGameObject()
        {
            ...
            return Instantiate(_poolData.data[_listCache].PooledObject,Vector3.zero,
                _poolData.data[_listCache].PooledObject.transform.rotation,_poolGroup[_listCache].transform);
        }
